...
export const NAV_PAGES = [
  ...
  { id:'incentiveHome',    label:'Incentive — dashboard' },
  ...
  { id:'salesIncentive',   label:'Salesman incentive' },
  { id:'salesIncentiveRule', label:'Sales incentive — rule' },
  ...
  { id:'colReconciliation', label:'Collections — reconciliation' },
  { id:'colReports',        label:'Collections — reports' },
  { id:'colEmployees',      label:'Collections — my activity / team performance' },
  { id:'colSettings',       label:'Collections — settings' },
