  ...
  return (
    <div>
      ...
      <div className="stat-grid">
        ...
        <Tile label="Overdue" value={money(t.overdueOutstanding)} sub={`${num(t.overdueDealers)} dealers past their credit days`} tone="var(--red)" onClick={() => go('colOutstanding', { status: 'OVERDUE' })} />
